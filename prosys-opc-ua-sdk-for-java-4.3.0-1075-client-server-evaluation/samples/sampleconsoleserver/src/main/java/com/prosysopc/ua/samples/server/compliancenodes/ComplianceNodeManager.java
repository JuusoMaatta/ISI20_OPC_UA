...
import com.prosysopc.ua.server.io.IoManagerAdapter;
...
public class ComplianceNodeManager extends NodeManagerUaNode {
  ...
  private static IoManagerListener listener = new IoManagerAdapter() {
    ...
    public AccessLevelType onGetUserAccessLevel(ServiceContext serviceContext, NodeId nodeId, UaVariable node) {
      ...
      return AccessLevelType.of(AccessLevelType.Fields.values());
    }
