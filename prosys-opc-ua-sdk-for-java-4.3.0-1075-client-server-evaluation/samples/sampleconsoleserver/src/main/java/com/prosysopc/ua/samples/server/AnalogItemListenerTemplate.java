...
/**
 * Example {@link com.prosysopc.ua.server.io.UaTypeIoListener} template that could be created with
 * code generator in future.
 */
public abstract class AnalogItemListenerTemplate extends UaTypeIoListenerImpl {
  ...
  protected boolean onWriteEngineeringUnits(ServiceContext serviceContext, AnalogItemType node, NumericRange indexRange,
      DataValue dataValue) {
    return false;
  }
  ...
  protected boolean onWriteInstrumentRange(ServiceContext serviceContext, AnalogItemType node, NumericRange indexRange,
      DataValue dataValue) {
    return false;
  }
