...
if not exist %bindir%\com\prosysopc\ua\samples\server\SimpleServer.class %JAVA_HOME%\bin\javac -classpath %CP% %srcdir%\com\prosysopc\ua\samples\server\*.java 

%JAVA_HOME%\bin\java -classpath %bindir%;%CP% com.prosysopc.ua.samples.server.SimpleServer %1 %2 %3 %4 %5 %6 %7 %8 %9
