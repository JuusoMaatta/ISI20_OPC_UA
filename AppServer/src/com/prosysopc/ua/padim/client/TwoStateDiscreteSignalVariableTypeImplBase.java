...
import com.prosysopc.ua.types.opcua.client.TwoStateDiscreteTypeImpl;
...
public abstract class TwoStateDiscreteSignalVariableTypeImplBase extends TwoStateDiscreteTypeImpl implements TwoStateDiscreteSignalVariableType {
  protected TwoStateDiscreteSignalVariableTypeImplBase(AddressSpace addressSpace, NodeId nodeId,
  ...
  @Optional
  @Override
  public void setActualValue(Boolean value) throws StatusException {
    UaVariable node = getActualValueNode();
    if (node == null) {
  ...
  @Optional
  @Override
  public void setSimulationValue(Boolean value) throws StatusException {
    UaVariable node = getSimulationValueNode();
    if (node == null) {
