...
import com.prosysopc.ua.types.opcua.client.AnalogUnitRangeTypeImpl;
...
public abstract class AnalogSignalVariableTypeImplBase extends AnalogUnitRangeTypeImpl implements AnalogSignalVariableType {
  protected AnalogSignalVariableTypeImplBase(AddressSpace addressSpace, NodeId nodeId,
  ...
  @Optional
  @Override
  public void setDamping(Float value) throws StatusException {
    UaVariable node = getDampingNode();
    if (node == null) {
      throw new RuntimeException("Setting Damping failed, the Optional node does not exist)");
    }
    node.setValue(value);
  }
