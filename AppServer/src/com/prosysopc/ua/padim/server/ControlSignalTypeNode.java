...
public class ControlSignalTypeNode extends ControlSignalTypeNodeBase {
  protected ControlSignalTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId,
  ...
  @Override
  protected void onAutoAdjustPositioner(ServiceContext serviceContext,
      ExecutionModeEnum executionMode) throws StatusException {
    //Implement the generated method here (and remove the code below) OR set implementation via static method setAutoAdjustPositionerMethodImplementation 
