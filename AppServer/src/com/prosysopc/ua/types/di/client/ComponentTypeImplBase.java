...
public abstract class ComponentTypeImplBase extends TopologyElementTypeImpl implements ComponentType {
  protected ComponentTypeImplBase(AddressSpace addressSpace, NodeId nodeId,
